    ...
    public function run(): void
    {
        ...
        $orders = [
            [
                ...
                'currency' => 'USD',
                'notes' => 'User requested express delivery',
                'shipping_address' => [
                    'name' => 'John Doe',
            ...
            [
                ...
                'total_amount' => 418.38,
                'currency' => 'USD',
                'notes' => 'User will pay via bank transfer',
                'shipping_address' => [
                    'name' => 'John Doe',
                    'address_line_1' => '123 Main Street',
                    'address_line_2' => 'Apt 4B',
            ...
            [
                ...
                'total_amount' => 166.99,
                'currency' => 'USD',
                'notes' => 'Order cancelled by user - full refund processed',
                'shipping_address' => [
                    'name' => 'Jane Smith',
                    'address_line_1' => '456 Oak Avenue',
                    'city' => 'Los Angeles',
        ...
        foreach ($orders as $orderData) {
            ...
            foreach ($items as $itemData) {
                OrderItem::create([
                    ...
                    'product_title' => $itemData['product']['name'], // Same as name for consistency
