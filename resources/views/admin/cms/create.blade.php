...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 mb-1">Create New Content</h2>
            <p class="text-muted mb-0">Add new content to your website</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.cms.store') }}" enctype="multipart/form-data" id="cms-form">
        @csrf
        <div class="row">
            <!-- Main Content -->
            <div class="col-lg-8">
