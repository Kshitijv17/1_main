      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="text-muted">
              <small><i class="fas fa-info-circle me-1"></i>Click "Edit" next to any user to manage their permissions individually</small>
            </div>
          </div>
        </div>
        <div class="card-body p-0">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div>
                          <a href="{{ route('admin.permissions.user.show', $admin) }}" 
                             class="btn btn-sm btn-outline-primary" 
                             title="Edit {{ $admin->name }}'s Permissions">
                    ...
                    <td>
                      ...
                      <br><small class="text-muted">{{ $admin->permissions->count() }} permissions</small>
                    </td>
          ...
          <div class="card-footer">
            <div class="d-flex justify-content-between align-items-center">
              <div class="text-muted">
                <small>Changes are saved automatically when you check/uncheck permissions</small>
              </div>
              <button type="button" class="btn btn-success" onclick="bulkUpdatePermissions()">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <ul class="list-unstyled">
                  ...
                  <li><span class="badge bg-primary">user</span> - Regular user access</li>
