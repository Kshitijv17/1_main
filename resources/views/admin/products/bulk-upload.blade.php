...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
      <a href="{{ route('vendor.products.csv-template') }}" class="btn btn-info me-2">
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('vendor.products.bulk-upload') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
              <a href="{{ route('vendor.products.csv-template') }}" class="btn btn-outline-info">
      ...
      @if(session('bulk_errors'))
        <div class="card mt-4">
          ...
          <div class="card-body">
            ...
            <div class="mt-3">
              <a href="{{ route('vendor.products.bulk-upload-form') }}" class="btn btn-warning">
