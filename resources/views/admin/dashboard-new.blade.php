    ...
    <div class="col-lg-4 col-md-6">
        <div class="card h-100 management-card">
            <div class="card-body text-center p-4">
                ...
                <p class="text-muted mb-4">Manage vendors, users, and user permissions</p>
                <div class="d-grid gap-2">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('admin.products.create') }}" class="btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('admin.categories.create') }}" class="btn btn-outline-success w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('admin.products.bulk-upload-form') }}" class="btn btn-outline-info w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('user.home') }}" class="btn btn-outline-secondary w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3" target="_blank">
                            <i class="fas fa-external-link-alt fa-2x mb-2"></i>
                            <span class="fw-semibold">View Store</span>
                            <small class="text-muted">user view</small>
                        </a>
                    </div>
                </div>
            </div>
