...
<head>
    ...
    <title>Vendor Registration - HerbnHouse</title>
...
<body>
                            ...
                            <div class="col-lg-6 auth-brand-side">
                                <div class="auth-brand-content">
                                    <div class="brand-logo">
                                        ...
                                        <h2 class="brand-title">Join Our Network</h2>
                                        <p class="brand-subtitle">Start your journey as a vendor with HerbnHouse</p>
                                    </div>
                                    ...
                                    <div class="features-list">
                                        <div class="feature-item">
                                            ...
                                            <div>
                                                <h5>Quick Setup</h5>
                                                <p>Get your store online in minutes</p>
                                            </div>
                                        </div>
                                        <div class="feature-item">
                            ...
                            <div class="col-lg-6 auth-form-side">
                                <div class="auth-form-content">
                                    <div class="form-header">
                                        ...
                                        <p>Join our community of successful vendors</p>
                                    </div>
                                    ...
                                    <form id="registerForm" action="{{ route('vendor.register.submit') }}" method="POST">
                                        @csrf
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group password-wrapper">
                                                        ...
                                                        <input type="password" name="password_confirmation" class="form-control toggle-password-input" 
                                    ...
                                    <div class="auth-links">
                                        <div class="text-center">
                                            ...
                                            <a href="{{ route('vendor.login') }}" class="btn btn-outline-primary">
    ...
    <script>
        ...
        $('#registerForm').on('submit', function(e) {
            ...
            btnText.html('<i class="fas fa-spinner fa-spin me-2"></i>Creating account...');
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#registerSuccess').removeClass('d-none').text('Account created successfully! Redirecting...');
                    setTimeout(function() {
                ...
                error: function(xhr) {
                    ...
                    if (xhr.status === 422 && errors.errors) {
                        ...
                        $('#registerError').removeClass('d-none').text(errors.message || 'Registration failed. Please try again.');
                    }
                },
                complete: function() {
                    // Reset button state
                    btn.prop('disabled', false);
                    btnText.html('<i class="fas fa-user-plus me-2"></i>Create Account');
