...
<div class="container py-5">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('user.product.show', $product) }}">{{ $product->name }}</a></li>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 order-lg-1">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('user.process-buy-now', $product) }}" method="POST" id="checkout-form">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="user_phone" id="user_phone" 
                                   ...
                                   value="{{ old('user_phone') }}" placeholder="+1 (555) 123-4567" required>
                            @error('user_phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <a href="{{ route('user.product.show', $product) }}" class="btn btn-outline-secondary btn-lg">
