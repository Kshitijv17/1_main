...
{
    /**
     * Display the main user homepage with products
     */
    ...
    public function category(Category $category, Request $request)
    {
        ...
        return redirect()->route('user.products', ['category' => $category->id]);
    }
    ...
    public function shop(Shop $shop, Request $request)
    {
        ...
        })->orderBy('sort_order', 'asc')->orderBy('title', 'asc')->get();

        return view('user.shop', compact('shop', 'products', 'categories'));
    }
