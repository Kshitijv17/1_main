...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vendor.products.index', compact('products', 'categories', 'stats', 'shop'));
    }
    ...
    public function create()
    {
        ...
        $categories = Category::orderBy('title')->get();
        return view('vendor.products.create', compact('categories', 'shop'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $productData['slug'] = Str::slug($productData['title']) . '-' . time();

        // Set selling price to price if not provided
        if (empty($productData['selling_price'])) {
    ...
    public function show(Product $product)
    {
        ...
        return view('vendor.products.show', compact('product', 'shop'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        $categories = Category::orderBy('title')->get();
        return view('vendor.products.edit', compact('product', 'categories', 'shop'));
    }
