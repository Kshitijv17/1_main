...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vendor.orders.index', compact('orders', 'stats', 'shop'));
    }
    ...
    public function show(Order $order)
    {
        ...
        // Ensure the order belongs to the current vendor's shop
        if (!$shop || $order->shop_id !== $shop->id) {
            abort(403, 'Unauthorized access to this order.');
        }

        $order->load(['user', 'items.product', 'shop']);
        return view('vendor.orders.show', compact('order', 'shop'));
    }
    ...
    public function edit(Order $order)
    {
        ...
        $order->load(['user', 'items.product', 'shop']);
        return view('vendor.orders.edit', compact('order', 'shop'));
    }
    ...
    /**
     * Cancel/Delete an order (only if it's in pending status)
     */
